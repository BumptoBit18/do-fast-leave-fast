    ...
    public void run() {
        try (Socket client = socket;
            ...
            if (raw == null || raw.isBlank()){
                output.write(JsonCodec.toJson(SocketResponse.error("Yêu cầu không hợp lệ").toMap()));
                output.newLine();
                output.flush();
                return;
            }
            ...
            System.err.println("[ServerHandler] Lỗi xử lý request từ client: " + ex.getClass().getSimpleName() + " - " + ex.getMessage());
