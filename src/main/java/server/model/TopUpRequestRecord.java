...
public class TopUpRequestRecord implements Serializable {
    ...
    public void approve(String adminUsername, LocalDateTime time) {
        this.status = "APPROVED";
        this.approvedBy = adminUsername;
        this.approvedAt = time;
    }

    public void markCredited(LocalDateTime time) {
        this.status = "CREDITED";
        this.creditedAt = time;
    }
}
